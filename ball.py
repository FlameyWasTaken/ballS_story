...
class Ball(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # Рисует жёлтый шарик
        pygame.draw.circle(self.display_surface, (255, 255, 0), (pos_x, pos_y), ball_rad)