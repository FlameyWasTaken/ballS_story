...
# Шрифты
EpilepsySansBold = "graphics/EpilepsySansBold.ttf"
MontserratBold = "graphics/Montserrat-Bold.ttf"

# General 2
pygame.display.set_caption("Flamey's project") # title слева сверху
screen = pygame.display.set_mode((width, height), pygame.RESIZABLE)
icon = pygame.image.load("graphics/uvst.png")
pygame.display.set_icon(icon)

# Изображения
menu_background = pygame.image.load("graphics/menu_background.png")
garlands = pygame.image.load("graphics/garlands.png")
sinti = pygame.image.load("graphics/sinti.jpg")
...
# Аудио
pygame.mixer.init()
pygame.mixer.music.load("audio/Bad Bunny - MONACO Instrumental.mp3") # Бэкграунд музяка
pygame.mixer.music.set_volume(0.1)
pygame.mixer.music.play(-1) # -1 означает бесконечное воспроизведение

click = pygame.mixer.Sound("audio/click.mp3") # Звуки клика
